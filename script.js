...
cells.addEventListener("click" , function(e){
    ...
    // console.log(e);
    currentCell.style.border = "solid";
    currentCell.style.borderBlockColor = "lightgreen";
    currentCell.style.borderLeftColor = "lightgreen";
    currentCell.style.borderRightColor = "lightgreen";
...
for(let i=0 ; i<allCells.length  ; i++){
    allCells[i].addEventListener("blur" , function(e){
        ...
        currentElement.style.borderBlockColor = "";
        currentElement.style.borderLeftColor = "";
        currentElement.style.borderRightColor = "";
